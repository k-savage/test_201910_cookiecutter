...
if not create_install_csci_utils:
    ...
    os.remove(os.path.join(base_dir, '{{cookiecutter.repo_name}}','{{cookiecutter.project_slug}}')) #removes a file.
    os.rmdir(os.path.join(base_dir, '{{cookiecutter.repo_name}}','{{cookiecutter.project_slug}}')) #removes an empty directory.
